  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex gap-3">
        <Link
          href="/catalog"
          className="rounded-lg bg-zinc-400 px-4 py-2 text-white transition hover:bg-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-300 active:bg-zinc-100"
        >
          Перейти в каталог
        </Link>
        <Link
